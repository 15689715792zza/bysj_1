(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = ("<h2>添加新职业</h2>\n<div>\n  <span>请输入以下信息： </span><br>\n  <label>职业编号:</label> <input #profTitleNo /><br>\n  <label>职业名称:</label> <input #profTitleName /><br>\n  <label>备注:</label> <textarea #profTitleRemarks></textarea>\n</div>\n<button (click)=\"goBack()\">返回</button>\n<button (click)=\"save(profTitleName.value,profTitleNo.value,profTitleRemarks.value)\">保存</button>\n\n");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _degree_add_degree_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./degree/add-degree.component */ "./src/app/degree/add-degree.component.ts");
            /* harmony import */ var _degree_update_degree_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./degree/update-degree.component */ "./src/app/degree/update-degree.component.ts");
            ...
            var routes = [
                ...
                { path: 'profTitle', component: _degree_degree_component__WEBPACK_IMPORTED_MODULE_10__["DegreeComponent"] },
                ...
                { path: 'addDepartment', component: _degree_add_degree_component__WEBPACK_IMPORTED_MODULE_11__["AddDegreeComponent"] },
                { path: 'addDegree', component: _degree_add_degree_component__WEBPACK_IMPORTED_MODULE_11__["AddDegreeComponent"] },
                { path: 'addProfTitle', component: _proftitle_add_proftitle_component__WEBPACK_IMPORTED_MODULE_13__["AddProftitleComponent"] },
                //  { path: 'addTeacher', component: AddTeacherCom},
                /** UPDATE */
                { path: 'updateCollege/:id', component: _college_update_college_component__WEBPACK_IMPORTED_MODULE_4__["UpdateCollegeComponent"] },
                { path: 'updateDegree/:id', component: _degree_update_degree_component__WEBPACK_IMPORTED_MODULE_12__["UpdateDegreeComponent"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _proftitle_proftitle_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./proftitle/proftitle.component */ "./src/app/proftitle/proftitle.component.ts");
            /* harmony import */ var _proftitle_add_proftitle_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./proftitle/add-proftitle.component */ "./src/app/proftitle/add-proftitle.component.ts");
            /* harmony import */ var _proftitle_update_proftitle_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./proftitle/update-proftitle.component */ "./src/app/proftitle/update-proftitle.component.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    declarations: [
                        ...
                        _degree_degree_component__WEBPACK_IMPORTED_MODULE_15__["DegreeComponent"],
                        _degree_add_degree_component__WEBPACK_IMPORTED_MODULE_16__["AddDegreeComponent"],
                        _degree_update_degree_component__WEBPACK_IMPORTED_MODULE_17__["UpdateDegreeComponent"],
                        _proftitle_proftitle_component__WEBPACK_IMPORTED_MODULE_18__["ProftitleComponent"],
                        _proftitle_add_proftitle_component__WEBPACK_IMPORTED_MODULE_19__["AddProftitleComponent"],
                        _proftitle_update_proftitle_component__WEBPACK_IMPORTED_MODULE_20__["UpdateProftitleComponent"]
                    ],
                    imports: [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDegreeComponent = /** @class */ (function () {
                function AddDegreeComponent(route, schoolService, location) {
                    this.route = route;
                    this.schoolService = schoolService;
                    this.location = location;
                }
                ...
                AddDegreeComponent.prototype.save = function (description, no, remarks) {
                    ...
                    this.schoolService.addDegree(this.degree)
                        .subscribe(function () { return _this.goBack(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DegreeComponent = /** @class */ (function () {
                function DegreeComponent(schoolService) {
                    this.schoolService = schoolService;
                }
                ...
                DegreeComponent.prototype.delete = function (degree) {
                    ...
                    this.schoolService.deleteDegree(degree).subscribe(function (res) { return alert(res.message); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateDegreeComponent = /** @class */ (function () {
                function UpdateDegreeComponent(route, schoolService, location) {
                    this.route = route;
                    this.schoolService = schoolService;
                    this.location = location;
                }
                UpdateDegreeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var id = this.route.snapshot.params.id;
                    this.schoolService.getDegree(id)
                ...
                UpdateDegreeComponent.prototype.save = function () {
                    var _this = this;
                    this.schoolService.updateDegree(this.degree)
                        .subscribe(function () { return _this.goBack(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddProftitleComponent = /** @class */ (function () {
                function AddProftitleComponent(route, schoolService, location) {
                    this.route = route;
                    this.schoolService = schoolService;
                    this.location = location;
                }
                ...
                AddProftitleComponent.prototype.save = function (description, no, remarks) {
                    ...
                    this.schoolService.addProfTitle(this.profTitle)
                        .subscribe(function () { return _this.goBack(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateProftitleComponent = /** @class */ (function () {
                function UpdateProftitleComponent(route, schoolService, location) {
                    this.route = route;
                    this.schoolService = schoolService;
                    this.location = location;
                }
                UpdateProftitleComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var id = this.route.snapshot.params.id;
                    this.schoolService.getprofTitle(id)
                ...
                UpdateProftitleComponent.prototype.save = function () {
                    var _this = this;
                    this.schoolService.updateProfTitle(this.profTitle)
                        .subscribe(function () { return _this.goBack(); });
                };
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! D:\Angular2Test\myapp_1\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
